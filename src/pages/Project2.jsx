...
function Project2() {
  return (
    <ProjectTemplate 
      ...
      introduction="Growing up I did gymnastics, where one of the younger kids had diabetes. He would often have to take breaks to get his levels glucose level checked which involved pricking his finger, which seemed very comfortable for a kid to have to go through."
...
layout="two-images" // Choose appropriate layout
      mediaContent={[
        ...
        { type: 'image', src: '/Portfolio_website/assets/project2_3.png', alt: 'Glucose Monitor' },
      ]}
homePath="/"
