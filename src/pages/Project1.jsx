...
function Project1() {
  return (
    <ProjectTemplate
      ...
      introduction= "I want to make a positive impact on our enviroment over my life span"
      ...
      approach="The designing process involved many iterations as we learned more about the complexities of bringing an idea into reality. One of my tasks in this project was building a prototype to showcase this idea. The prototype was a wooden box with some electronic circuits to detect the light refraction angles for sorting glass bottles."
      learnings="This experience was amazing! We got to meet creative students from all over the country as well as some Irish celebrities and politicians. This project inspired me to gain more technical experience so I can bring my ideas into the world which is how I ended up studying engineering at Trinity College Dublin"
      layout="three-images" 
      mediaContent={[
