...
const ArtAndPhotography = () => {
  const images = [
    ...
    { src: '/Portfolio_website/assets/photo8.jpg', caption: 'Beautiful Landscape 8', aspectRatio: 3/4 },
    { src: '/Portfolio_website/assets/photo9.jpg', caption: 'Beautiful Landscape 9', aspectRatio: 16/9 },
  ];
