...
function Project3() {
  return (
    <ProjectTemplate 
      ...
      learnings="For this project I kept a detailed design journal that really helped to organise my ideas. I learned how to design, react, and prototype in a fast nature to meet unforeseen scenerios such as a reduced supply chain for materials. It felt good to work on something that could bring people together during such a lonely time."
      layout= "three-images"
      mediaContent={[
